...
export default function Post() {
    ...
    const showTab = (n) => {
        ...
        const prevBtn = document.getElementById(`prevBtn${currentStep}`);
            ...
            <div className="row d-flex justify-content-center align-items-center">
                <div className="col-md-6">
                    ...
                    <h1 id="register"> </h1>
                        ...
                        <div className="row mt-3">
                            <div className="col-md-6">
                                <button type="button" id={`prevBtn${currentStep}`} onClick={() => { handlePrevious(); nextPrev(-1) }} className="btn btn-primary mr-2">Previous</button>
                                <button type="button" id={`nextBtn${currentStep}`} onClick={() => { handleNext(); nextPrev(1) }} className="btn btn-primary">Next</button>
                            </div>
                        </div>
                    </form>
                </div>
