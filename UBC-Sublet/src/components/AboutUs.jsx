...
export default function AboutUs() {
    return (
        <div>
        <div className="AboutUs" style = {{ marginTop : "12%", justifyContent: "center", height: "140%" }}>
        <h2 style = {{ marginTop: "4% !important", marginLeft: "41%" }}> Our Mission </h2>
               <div className="ourMission" style = {{ marginLeft: "0px", marginTop: "2%", paddingLeft: "20px"}}>
                ...
                <h2 className= "STORY2 " style = {{ marginTop: "2%" }}> How did we come up with this idea? </h2>
